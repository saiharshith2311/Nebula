...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.error("Please ensure your .env file contains these variables before running this script.");
  process.exit(1);
}
...
async function seed() {
  console.log(`Starting to seed ${newReviews.length} new elective reviews...`);
  ...
  console.log(`Successfully seeded ${data.length} elective reviews into the Supabase database!`);
}
